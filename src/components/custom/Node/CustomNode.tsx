...
const CustomNodes = ({ data, isConnectable }) => {
    ...
    const handleSucceessorsClick = useCallback(() => {
        ...
        if (!showSuccessors){
            ...
            // reactFlowInstance.setNodes(transformUsersDataToReactFlowNodes(data, undefined, true))
        } else {
            reactFlowInstance.deleteElements({nodes: transformUsersDataToReactFlowNodes(data.mySuccessors,undefined, false)})
        }
